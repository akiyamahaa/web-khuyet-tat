  ...
  const events = [
    {
      ...
      subtitle:
        "Dự án hướng đến việc góp phần nâng cao chất lượng cuộc sống của người khuyết tật thông qua nâng cao chất lượng và hiệu quả của việc xây dựng và thực thi chính sách đối với người khuyết tật.",
    },
    {
      img: event2,
      title: `Dự án "Cơ hội và hòa nhập cho người khuyết tật"`,
  ...
  const news = [
    {
      ...
      subtitle:
        "Nhiều sản phẩm thủ công mỹ nghệ xuất khẩu sang thị trường châu Âu, châu Á được chính đôi bàn tay của những người khuyết tật, neo đơn, có hoàn cảnh khó khăn làm ra.",
    },
    {
      img: news2,
      title: `Người khuyết tật tạo ra những sản phẩm xuất sang "trời tây"`,
  ...
  return (
    <div className="w-full overflow-hidden">
      <div>
        ...
        <Section title="Mục tiêu" additionalClassName="md:px-[224px] sm:px-5">
