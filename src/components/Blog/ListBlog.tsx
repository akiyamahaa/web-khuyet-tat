...
const ListBlog = () => {
  ...
  return (
    <div className='w-[75%] m-auto pt-[6rem] pb-[8rem] flex flex-col justify-center'>
      ...
      <CustomPagination className='mt-16 w-full md:w-auto mx-auto  space-x-1' count={Math.ceil(dataBlogs.length / pageSize)} variant="outlined" onChange={handleChange} page={page} color="primary" />
    </div>
  )
}
